...
/**
 * @file eaf_dec.h
 * @brief EAF (Emote Animation Format) Decoder for LVGL
 *
 ...
 * @return ESP_OK on success, ESP_FAIL on failure
 */
esp_err_t lv_eaf_jpeg_decode(const uint8_t *input_data, size_t input_size,
                          uint8_t *output_buffer, size_t *out_size,
                          bool swap_color);
 ...
 *
 * Releases resources allocated by lv_eaf_hw_jpeg_init().
 *
